...
public class DBQuery {
 public static String create_user =  "create table " + QueryField.TABLE_USERS +" (id INTEGER PRIMARY KEY AUTOINCREMENT,user_id INTEGER, username TEXT,password TEXT, opcode TEXT, baseUrl TEXT)" ;
