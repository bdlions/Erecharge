                            ...
                            Thread bkashThread = new Thread() {
                                ...
                                public void run()
                                {
                                    try
                                    {
                                        ...
                                        HttpPost post = new HttpPost(baseUrl+"androidapp/transaction/topup");
                                        ...
                                        if(result != null) {
                                            ...
                                            if(responseCode == 2000){
                                                ...
                                                setResult(Constants.PAGE_TOPUP_TRANSACTION_SUCCESS, intent);
                                                finish();
                                            }
                                            else if(responseCode == 5001)
                                            {
                                                progress.dismiss();
                                                Intent intent = new Intent();
                                                setResult(Constants.PAGE_TOPUP_SESSION_EXPIRED, intent);
                                                finish();
                                            }
                                            else {
                                                String message = "";
                                                ...
                                                setResult(Constants.PAGE_TOPUP_SERVER_ERROR, intent);
                                                finish();
                                            }
                                        }
                                        else
                                        ...
                                        Intent intent = new Intent();
                                        setResult(Constants.PAGE_TOPUP_SERVER_UNAVAILABLE, intent);
                                        finish();
                                    }
                                    progress.dismiss();
                                }
