...
public class mCash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextCellNumber = (EditText) findViewById(R.id.etMobileNumbermCash);
                            ...
                            Thread bkashThread = new Thread() {
                                ...
                                public void run() {
                                    try {
                                        ...
                                        HttpPost post = new HttpPost(baseUrl + "androidapp/transaction/mcash");
                                        ...
                                        if (result != null) {
                                            ...
                                            if (responseCode == 2000) {
                                                ...
                                                setResult(Constants.PAGE_MCASH_TRANSACTION_SUCCESS, intent);
                                                finish();
                                            } else if (responseCode == 5001) {
                                                progress.dismiss();
                                                Intent intent = new Intent();
                                                setResult(Constants.PAGE_MCASH_SESSION_EXPIRED, intent);
                                                finish();
                                            } else {
                                                String message = "";
                                                try {
                                                ...
                                                setResult(Constants.PAGE_MCASH_SERVER_ERROR, intent);
                                                finish();
                                            }
                                        } else {
                                            Intent intent = new Intent();
                                        ...
                                        Intent intent = new Intent();
                                        setResult(Constants.PAGE_MCASH_SERVER_UNAVAILABLE, intent);
                                        finish();
                                    }
                                    progress.dismiss();
                                }
