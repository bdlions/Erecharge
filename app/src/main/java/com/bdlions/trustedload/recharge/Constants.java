...
public class Constants {
    ...
    public static final String URL_LOGIN = "androidappv2/auth/login";
    public static final String URL_PIN = "androidappv2/auth/pin";
    public static final String URL_PACKAGE_DETAILS = "androidappv2/transaction/get_package_details";
    public static final String URL_TRANSACTION_TOPUP = "androidappv2/transaction/topup";
    public static final String URL_TRANSACTION_LIST_TOPUP = "androidappv2/transaction/get_topup_transaction_list";
    public static final String URL_TRANSACTION_BKASH = "androidappv2/transaction/bkash";
    public static final String URL_TRANSACTION_LIST_BKASH = "androidappv2/transaction/get_bkash_transaction_list";
    public static final String URL_TRANSACTION_DBBL = "androidappv2/transaction/dbbl";
    public static final String URL_TRANSACTION_LIST_DBBL = "androidappv2/transaction/get_dbbl_transaction_list";
    public static final String URL_TRANSACTION_MCASH = "androidappv2/transaction/mcash";
    public static final String URL_TRANSACTION_LIST_MCASH = "androidappv2/transaction/get_mcash_transaction_list";
    public static final String URL_TRANSACTION_UCASH = "androidappv2/transaction/ucash";
    public static final String URL_TRANSACTION_LIST_UCASH = "androidappv2/transaction/get_ucash_transaction_list";
    public static final String URL_TRANSACTION_LIST_PAYMENT = "androidappv2/transaction/get_payment_transaction_list";
    public static final String URL_UPDATE_PASSWORD = "androidappv2/auth/update_password";
