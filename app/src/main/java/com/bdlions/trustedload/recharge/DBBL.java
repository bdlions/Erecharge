...
public class DBBL extends AppCompatActivity {
    ...
    private static RadioGroup radioGroupDBBLPackage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroupDBBLPackage = (RadioGroup) findViewById(R.id.radioTypeDBBL);
        ...
        actvCellNumber = (AutoCompleteTextView) findViewById(R.id.actvMobileNumberDBBL);
        ...
        buttonDBBLSend.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            int radioButtonID = radioGroupDBBLPackage.getCheckedRadioButtonId();
                            View radioButton = radioGroupDBBLPackage.findViewById(radioButtonID);
                            //package id 1 is Cashin and 2 is Cashout. index of prepaid is 0 and postpaid is 1
                            final int packageId = radioGroupDBBLPackage.indexOfChild(radioButton)+1;
                            if(packageId == 1)
                            {
                                serviceId = Constants.SERVICE_TYPE_ID_DBBL_CASHIN;
                            }
                            else if(packageId == 2)
                            {
                                serviceId = Constants.SERVICE_TYPE_ID_DBBL_CASHOUT;
                            }
                            ...
                            Thread bkashThread = new Thread() {
                                ...
                                public void run() {
                                    try
                                    {
                                        ...
                                        HttpPost post = new HttpPost(baseUrl + Constants.URL_TRANSACTION_DBBL);
